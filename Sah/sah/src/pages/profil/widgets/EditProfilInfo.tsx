			...
			<Grid container spacing={1}>
				...
				<Grid item xs={12} display="flex" flexDirection="row" gap={2}>
					<TextField
						...
						fullWidth
						label='Experience'
						value={userFormData?.xp}
						inputProps={{ style: { textAlign: 'center' } }}
						onChange={(e) => setUserFormData({ ...user, xp: parseInt(e.target.value) })}
						InputProps={{
							endAdornment: <>
								<IconButton disableRipple>
									<img src="./assets/gif/location.gif" alt="location gif aimated" />
					...
					<TextField
						...
						fullWidth
						label='Entreprise'
						value={userFormData?.society}
						inputProps={{ style: { textAlign: 'center' } }}
						onChange={(e) => setUserFormData({ ...user, society: e.target.value })}
						InputProps={{
							endAdornment: <>
								<IconButton disableRipple>
									<img src="./assets/gif/location.gif" alt="location gif aimated" />
